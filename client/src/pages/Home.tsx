...
export default function Home() {
  ...
  const [urgencyLevel, setUrgencyLevel] = useState<string>("Urgencia Hoy Mismo");
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans antialiased selection:bg-amber-400 selection:text-slate-950 flex flex-col justify-between">
      {/* Barra superior de urgencia y confianza */}
      <div className="bg-slate-950 text-slate-100 text-xs sm:text-sm py-2 px-4 border-b border-slate-800">
